...
const home = () => {
  return (
    <div>
      <div className="flex justify-between px-12 hero">
        <div className=" flex flex-col mt-36  items-center overflow-hidden text-[1.5vw] leading-tight font-medium text-left ml-28 animate-dropin">
          ...
          <button className="self-start p-2 mt-6 text-xl font-normal transition duration-300 ease-in-out rounded-md flex-start delay-15 hover:-translate-y-1 hover:scale-120">
          Résumé
          </button>
        </div>
